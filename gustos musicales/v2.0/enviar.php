<?php
    ...
    if(!empty($_POST['nombre']) && !empty($_POST['clave'])){
        ...
        foreach ($_POST['dispositivos'] as $key => $value) {
            if($auxiliar && !empty($value)){
                $auxiliar = true;
            }else{
                $auxiliar = false;
            }
        ...
        if($auxiliar){
          ...
          $sql = "INSERT INTO usuarios(nombre,clave) VALUES ('".$_POST['nombre']."','".$_POST['clave']."')";
           /* echo $sql; */
            ...
            if($conexion->affected_rows>0){
                    ...
                    foreach ($_POST['dispositivos'] as $key => $value) {
                        $sql="INSERT INTO dispositivos(idUsuario,dispositivo) VALUES (".$id.",'".$value."')";
                        $conexion->query($sql);
                    }
          ...
          $sql = "INSERT INTO usuarios(nombre,clave) VALUES ('".$_POST['nombre']."','".$_POST['clave']."')";
           /* echo $sql; */
            ...
            echo '<a href="solicitarDispositivos.php"><h1>Introduce dispositivos</h1></a>';
        }
        }
